package com.henez.distant.misc.screenshotter;
...
import static com.henez.distant.global.Global.GAME_PACKAGE_NAME;
...
public class Screenshotter {
    ...
    public static void saveScreenshot() {
        ...
        PixmapIO.writePNG(Gdx.files.external(pathExternal + "screenshots\\" + screenshotterSaver.getDateAsFolderName() + "\\cnf_" + screenshotterSaver.getDateToday() + "_" + screenshotterSaver.getDailyScreenshotCount() + ".png"),
                          pixmap);
        pixmap.dispose();
